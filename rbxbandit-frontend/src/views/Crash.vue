...
<style scoped>
    ...
    .crash .crash-container {
        width: 1120px;
        border-radius: 25px;
        background: radial-gradient(163.2% 163.2% at 50% -31.45%,hsla(0, 0%, 4%, 0.705) 0,transparent 100%),linear-gradient(255deg,#272727,#1d1d1d);
        box-shadow: 0 4px 10px rgba(36,36,36,.25);
    }

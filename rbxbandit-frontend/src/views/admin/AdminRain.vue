...
<style scoped>
    ...
    .admin-rain .list-content {
        ...
        margin-top: 20px;
        padding: 20px 0;
        border-top: 1px solid rgba(155, 17, 17, 0.5);
        border-bottom: 1px solid rgba(109, 24, 24, 0.5);
    }
    ...
    .admin-rain .list-pagination button:before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, #3a0101 0%, #3a0101 100%);
    ...
    .admin-rain .filter-actions button.button-update {
        ...
        margin-top: 12px;
        border-radius: 5px;
        background: linear-gradient(255deg, #3a0101 0%, #3a0101 100%);
    }
    ...
    .admin-rain .stats-pot {
        ...
        align-items: center;
        border-radius: 15px;
        background: radial-gradient(60% 55% at 50% 100%, rgba(204, 9, 9, 0.2) 0%, rgba(1, 247, 185, 0) 100%);
        border: 1px dashed #3a0101;
    }
    ...
    .admin-rain .amount-value {
        font-size: 20px;
        font-weight: 600;
        background: linear-gradient(250deg, #ff0303 0%, #ff0000 100%), #a6cae8;

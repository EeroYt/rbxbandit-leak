...
<style scoped>
    ...
    .profile-games .games-pagination button:before {
        ...
        top: 0;
        left: 0;
        background: linear-gradient(180deg, #1f1f1f 0%, #505050 100%);
        border-radius: 10px;
        z-index: -1;
    }

    .profile-games .games-pagination button:disabled:before {
        background: linear-gradient(180deg, rgba(0, 0, 0, 0) 0%, #1f1f1f 100%);
    }
    ...
    .profile-games .games-pagination button .button-inner {
        ...
        justify-content: center;
        align-items: center;
        background: linear-gradient(255deg, rgba(17, 17, 17, 0.1) 0%, rgba(20, 20, 20, 0.1) 100%), rgba(0, 0, 0, 0.1);
